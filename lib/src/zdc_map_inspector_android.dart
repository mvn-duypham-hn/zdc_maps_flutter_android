...
/// An Android of implementation of [ZdcMapsInspectorPlatform].
@visibleForTesting
class ZdcMapsInspectorAndroid extends ZdcMapsInspectorPlatform {
  /// Creates a method-channel-based inspector instance that gets the channel
  /// for a given map ID from [channelProvider].
  ZdcMapsInspectorAndroid(MethodChannel? Function(int mapId) channelProvider)
